...
export default function CatalogModal({ isOpen, onClose }: CatalogModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 px-4">
      <div className="bg-white border border-gray-200 rounded-3xl p-8 max-w-4xl w-full h-[80vh] relative animate-fade-up">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <button
          ...
          className="absolute top-4 left-4 text-gray-500 hover:text-black flex items-center gap-2"
        >
          <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
